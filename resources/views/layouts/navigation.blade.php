            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-10 sm:space-x-2">
                    ...
                    <a href="{{ route('catatan-soc.index') }}"
                        class="flex items-center px-3 py-2.5 text-base font-medium rounded-lg transition-colors {{ request()->routeIs('catatan-soc.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
