                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-blue-700 mt-1">Sistem akan menghitung downtime (menit & jam), SLA per kejadian, dan SLA tahunan secara otomatis menggunakan formula: SLA = 100 - (downtime_jam / 24 * 100)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <ul class="space-y-1 text-gray-700">
                                        <li>• SLA per Kejadian (berdasarkan downtime/24 jam)</li>
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <textarea id="keterangan" name="keterangan" rows="4"
                                    ...
                                    placeholder="Jelaskan detail insiden yang terjadi...">{{ old('keterangan') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="tindak_lanjut" name="tindak_lanjut" rows="3"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
                                    placeholder="Langkah-langkah tindak lanjut yang dilakukan...">{{ old('tindak_lanjut') }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <select id="direspon_oleh" name="direspon_oleh[]" multiple
                                ...
                                @foreach($responderOptions as $responder)
                                    <option value="{{ $responder }}" {{ in_array($responder, old('direspon_oleh', [])) ? 'selected' : '' }}>
                                        {{ $responder }}
                                    </option>
                                @endforeach
                            </select>
